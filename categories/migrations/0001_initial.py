    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('factor', models.SmallIntegerField(default=1, verbose_name='factor')),
                ('count', models.PositiveIntegerField(default=0, verbose_name='count')),
                ('is_customer_travel', models.BooleanField(default=False, verbose_name='is customer travel')),
                ('is_pro_travel', models.BooleanField(default=False, verbose_name='is customer travel')),
                ('is_remote_ok', models.BooleanField(default=False, verbose_name='is customer travel')),
                ('popular_level', models.PositiveIntegerField(default=0, verbose_name='popular_level')),
                ('origin', models.CharField(max_length=100, null=True, verbose_name='origin', blank=True)),
                ('position_name', models.CharField(max_length=255, null=True, verbose_name='position name', blank=True)),
                ('parent', mptt.fields.TreeForeignKey(related_name=b'children', verbose_name='parent', blank=True, to='categories.Category', null=True)),
            ],
            options={
