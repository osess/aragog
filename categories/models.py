...
class Category(CategoryBase):
    ...
    meta_extra = models.TextField(
        ...
        # add by recall
    factor = models.SmallIntegerField(default=1,verbose_name=_("factor"))
    # 该分类被使用的次数,定期进行统计
    count = models.PositiveIntegerField(default=0,verbose_name=_("count"))
    # add by yzy
    # 服务相关 创建服务时添加默认的服务有效区域选择
    is_customer_travel = models.BooleanField(default=False,verbose_name=_("is customer travel"))
    is_pro_travel      = models.BooleanField(default=False,verbose_name=_("is customer travel"))
    is_remote_ok       = models.BooleanField(default=False,verbose_name=_("is customer travel"))

    # popular
    popular_level = models.PositiveIntegerField(default=0,verbose_name=_("popular_level"))
    origin = models.CharField(max_length=100,blank=True,null=True,verbose_name=_("origin"))

    # position
    position_name = models.CharField(max_length=255,blank=True,null=True,verbose_name=_("position name"))
